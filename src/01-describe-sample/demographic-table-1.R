...
demographics_general_1 <-
  ...
  filter(variable %in% c(
    "Education Level", "Employment Status", "Gender", "Marital Status", "Birth Year", "Annual Income", "Military Statys", "History of Head Injury"
  ))
...
# Save --------------------------------------------------------------------
demographics_general_1 %>% readr::write_csv(here::here('output/demographics-1-general.csv'))
demographics_military_1 %>% readr::write_csv(here::here('output/demographics-1-military.csv'))
