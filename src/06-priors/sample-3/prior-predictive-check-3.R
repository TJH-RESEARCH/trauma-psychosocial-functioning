...
data_sim_3 <-
  expand_grid(
    mios_total = seq(-1.5, 3.5, by = .5), 
    pcl_total = seq(-1.5, 2.5, by = .5), 
    ...
    service_era = c('Cold War', 'Vietnam', 'Persian Gulf', 'Post 911'),
